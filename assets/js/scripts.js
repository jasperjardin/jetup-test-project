...
$(document).ready(function () {
  if(isLoaded) {
    ...
    $('.page-preloader .loader').stop(true, true).delay(1450).animate({ opacity: '0' }, 200, 'easeOutExpo', function () {
...
(function() {
    ...
    function initHeader() {
        ...
        largeHeader = document.getElementById('animation-wrapper');
        ...
        for(var i in points) {
            var c = new Circle(points[i], 2+Math.random()*2, 'rgba(60,56,56,0.3)');
            points[i].circle = c;
        }
    }
